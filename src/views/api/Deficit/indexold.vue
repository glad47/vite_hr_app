<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="شهر الاستحقاق (1-12)" prop="dueMonth">
        <el-input
          v-model="queryParams.dueMonth"
          placeholder="请输入شهر الاستحقاق (1-12)"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['api:Deficit:export']"
        >导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="DeficitList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="المعرف للعجز" align="center" prop="id" />
      <el-table-column label="معرف الموظف" align="center" prop="empId" />
      <el-table-column label="سنة الاستحقاق" align="center" prop="dueYear" />
      <el-table-column label="شهر الاستحقاق (1-12)" align="center" prop="dueMonth" />
      ...
      <el-table-column label="ملاحظات العجز" align="center" prop="note" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="شهر الاستحقاق (1-12)" prop="dueMonth">
          <el-input v-model="form.dueMonth" placeholder="请输入شهر الاستحقاق (1-12)" />
        </el-form-item>
        <el-form-item label="مبلغ العجز" prop="amount">
          <el-input v-model="form.amount" placeholder="请输入مبلغ العجز" />
        </el-form-item>
        <el-form-item label="اسم المشرف" prop="supervisorName">
          <el-input v-model="form.supervisorName" placeholder="请输入اسم المشرف" />
        </el-form-item>
        <el-form-item label="ملاحظات العجز" prop="note">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        dueMonth: [
          { required: true, message: "شهر الاستحقاق (1-12)不能为空", trigger: "blur" }
        ],
        amount: [
          { required: true, message: "مبلغ العجز不能为空", trigger: "blur" }
        ],
      }
    }
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除العجوزات编号为"' + ids + '"的数据项？').then(function() {
